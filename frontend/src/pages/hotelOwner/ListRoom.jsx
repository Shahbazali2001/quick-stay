...
const ListRoom = () => {
  ...
  const {axiosInstance, getToken, user, currency} = useAppContext();

  const fetchRooms = async () => {
    try {
      const { data } = await axiosInstance.get("/api/rooms/owner", {
        headers: {
  ...
  return (
    <div>
      <Title
        ...
        align="left"
        font="outfit"
        subTitle="Manage and list your hotel rooms with ease. Add details, photos, and availability, and let users book your rooms effortlessly."
      />
