...
const Dashboard = () => {
  ...
  const {user, currency, getToken, axiosInstance} = useAppContext();
  ...
  return (
    <div>
        <Title align="left" title="Dashboard" subTitle="Monitor and manage your room listings, bookings, and revenue. Stay up-to-date with key metrics and insights to optimize your hotel experience." font="outfit" />
        <div className='flex gap-4 my-8'>
            {/* Total Bookings */}
            <div className='bg-primary/3 border border-gray-300 rounded flex p-4 pr-8'>
              <img src={assets.totalBookingIcon} alt="" className='max-sm:hidden h-10' />
              <div className='flex flex-col sm:ml-4 font-medium gap-2'>
