...
const Hero = () => {
  ...
  const {navigate, getToken, setSearchedCities, axiosInstance} = useAppContext();
  ...
  //  Call api to save recent searched city
   ...
   await axiosInstance.post("/api/user/store-recent-search", {recentSearchedCity: destination}, {headers: {Authorization: `Bearer ${token}`}});
